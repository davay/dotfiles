...
-- Appearance
c.appearance.color        = { white = 0.2, red = 0.1, blue = 0.1 } -- Indicator background color, e.g., {red = 0.5, blue = 0 }
c.appearance.alpha        = 1 -- Opacity of active indicators
c.appearance.dimmer       = 3 -- Higher numbers increase contrast b/n focused & unfocused state
